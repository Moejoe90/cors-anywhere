...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    function getWhitelist (whitelist,origin) {
      return origin ? !!origin.contains(whitelist):false;
    }
    ...
    if (corsAnywhere.originWhitelist.length && corsAnywhere.originWhitelist.some(getWhitelist,origin)) {
      res.writeHead(403, 'Forbidden', cors_headers);
