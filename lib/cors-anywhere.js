...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    function getWhitelist (whitelist) {
      console.log(!origin.includes(whitelist));
      return origin ? !origin.includes(whitelist) : false;
    }
    ...
    if (corsAnywhere.originWhitelist.length && corsAnywhere.originWhitelist.some(getWhitelist)) {
      res.writeHead(403, 'Forbidden', cors_headers);
